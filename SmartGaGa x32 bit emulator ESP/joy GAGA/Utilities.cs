...
namespace PUBGMESP
{
    ...
    public class SigScanSharp
    {
        ...
        {
            [DllImport(@"C:\JOY X.dll", EntryPoint = "CreateInstance")]
            static extern IntPtr BypaPH_ctor(uint pID);
            [DllImport(@"C:\JOY X.dll", EntryPoint = "DeleteInstance")]
            static extern void BypaPH_dtor(IntPtr pInstance);
            [DllImport(@"C:\JOY X.dll", EntryPoint = "RWVM")]
    ...
    public class GameMemSearch
    {
        ...
        public long[] ViewWorldSearchCandidates(long startAddv = 0x70000000, long endAddv = 0x90000000)
        {
